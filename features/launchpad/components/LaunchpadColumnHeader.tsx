  ...
  return (
    <div className="flex items-center justify-between border-b border-[var(--border)] bg-[#160b30] px-4 py-3">
      ...
      <div className="flex items-center gap-2 text-xs text-[var(--muted)]">
        <div className="flex items-center gap-1 rounded-[4px] border border-[var(--border)] bg-[var(--surface)] px-2 py-1">
        ...
        <button
          type="button"
          className="flex items-center gap-1 rounded-[4px] border border-[var(--border)] bg-[var(--surface)] px-2 py-1 text-[var(--text)]"
        >
