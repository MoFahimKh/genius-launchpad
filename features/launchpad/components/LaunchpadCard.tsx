...
export function LaunchpadCard({ item }: { item: LaunchpadItem }) {
  return (
    <div className="h-32.5 w-full max-w-full cursor-pointer overflow-hidden border-b border-(--border) bg-background px-4 py-2 transition-all hover:bg-linear-to-l hover:from-[#09001A] hover:via-[rgba(28,16,58,0.80)] hover:to-[rgba(36,23,71,0.50)]">
